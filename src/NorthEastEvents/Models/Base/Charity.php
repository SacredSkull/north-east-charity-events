...
abstract class Charity implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\NorthEastEvents\\Models\\Map\\CharityTableMap';
    ...
    /**
     * Initializes internal state of NorthEastEvents\Models\Base\Charity object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\NorthEastEvents\Models\Charity The current object (for fluent API support)
     */
    ...
    public function setBio($v)
    {
        ...
        if ($this->bio !== $v) {
            $this->bio = $v;
            $this->modifiedColumns[CharityTableMap::COL_BIO] = true;
        }
    ...
    public function setLogo($v)
    {
        ...
        if ($this->logo !== $v) {
            $this->logo = $v;
            $this->modifiedColumns[CharityTableMap::COL_LOGO] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->created_at->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[CharityTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($this->updated_at === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->updated_at->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[CharityTableMap::COL_UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : CharityTableMap::translateFieldName('Bio', TableMap::TYPE_PHPNAME, $indexType)];
            $this->bio = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : CharityTableMap::translateFieldName('Logo', TableMap::TYPE_PHPNAME, $indexType)];
            $this->logo = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : CharityTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : CharityTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 6; // 6 = CharityTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\NorthEastEvents\\Models\\Charity'), 0, $e);
        }
    }
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(CharityTableMap::COL_CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(CharityTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(CharityTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->eventsScheduledForDeletion !== null) {
                if (!$this->eventsScheduledForDeletion->isEmpty()) {
                    \NorthEastEvents\Models\EventQuery::create()
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CharityTableMap::COL_BIO)) {
            $modifiedColumns[':p' . $index++]  = 'bio';
        }
        if ($this->isColumnModified(CharityTableMap::COL_LOGO)) {
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\NorthEastEvents\Models\Charity
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\NorthEastEvents\Models\Charity The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CharityTableMap::COL_BIO)) {
            $criteria->add(CharityTableMap::COL_BIO, $this->bio);
        }
        if ($this->isColumnModified(CharityTableMap::COL_LOGO)) {
            $criteria->add(CharityTableMap::COL_LOGO, $this->logo);
        }
        if ($this->isColumnModified(CharityTableMap::COL_CREATED_AT)) {
            $criteria->add(CharityTableMap::COL_CREATED_AT, $this->created_at);
        }
        if ($this->isColumnModified(CharityTableMap::COL_UPDATED_AT)) {
            $criteria->add(CharityTableMap::COL_UPDATED_AT, $this->updated_at);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \NorthEastEvents\Models\Charity (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \NorthEastEvents\Models\Charity Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildCharity is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildCharity The current object (for fluent API support)
     */
