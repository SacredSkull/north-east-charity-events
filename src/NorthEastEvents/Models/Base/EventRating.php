...
/**
 * Base class that represents a row from the 'event_rating' table.
 *
 *
 *
* @package    propel.generator.NorthEastEvents.Models.Base
*/
abstract class EventRating implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\NorthEastEvents\\Models\\Map\\EventRatingTableMap';
    ...
    /**
     * Initializes internal state of NorthEastEvents\Models\Base\EventRating object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>EventRating</code> instance.  If
     * <code>obj</code> is an instance of <code>EventRating</code>, delegates to
     * <code>equals(EventRating)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|EventRating The current object, for fluid interface
     */
    ...
    public function setRating($v)
    {
        ...
        if ($this->rating !== $v) {
            $this->rating = $v;
            $this->modifiedColumns[EventRatingTableMap::COL_RATING] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->created_at->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[EventRatingTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : EventRatingTableMap::translateFieldName('EventID', TableMap::TYPE_PHPNAME, $indexType)];
            $this->eventid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : EventRatingTableMap::translateFieldName('UserID', TableMap::TYPE_PHPNAME, $indexType)];
            $this->userid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : EventRatingTableMap::translateFieldName('Rating', TableMap::TYPE_PHPNAME, $indexType)];
            $this->rating = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : EventRatingTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : EventRatingTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 5; // 5 = EventRatingTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\NorthEastEvents\\Models\\EventRating'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildEventRatingQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see EventRating::setDeleted()
     * @see EventRating::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildEventRatingQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(EventRatingTableMap::COL_CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(EventRatingTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(EventRatingTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(EventRatingTableMap::COL_EVENTID)) {
            $modifiedColumns[':p' . $index++]  = 'eventID';
        }
        if ($this->isColumnModified(EventRatingTableMap::COL_USERID)) {
            $modifiedColumns[':p' . $index++]  = 'userID';
        }
        if ($this->isColumnModified(EventRatingTableMap::COL_RATING)) {
        ...
        $sql = sprintf(
            'INSERT INTO event_rating (%s) VALUES (%s)',
    ...
    {
        $pos = EventRatingTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $alreadyDumpedObjects['EventRating'][$this->hashCode()] = true;
        $keys = EventRatingTableMap::getFieldNames($keyType);
        $result = array(
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\NorthEastEvents\Models\EventRating
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\NorthEastEvents\Models\EventRating The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(EventRatingTableMap::COL_EVENTID)) {
            $criteria->add(EventRatingTableMap::COL_EVENTID, $this->eventid);
        }
        if ($this->isColumnModified(EventRatingTableMap::COL_USERID)) {
            $criteria->add(EventRatingTableMap::COL_USERID, $this->userid);
        }
        if ($this->isColumnModified(EventRatingTableMap::COL_RATING)) {
            $criteria->add(EventRatingTableMap::COL_RATING, $this->rating);
        }
        if ($this->isColumnModified(EventRatingTableMap::COL_CREATED_AT)) {
            $criteria->add(EventRatingTableMap::COL_CREATED_AT, $this->created_at);
        }
        if ($this->isColumnModified(EventRatingTableMap::COL_UPDATED_AT)) {
            $criteria->add(EventRatingTableMap::COL_UPDATED_AT, $this->updated_at);
        }
    ...
    {
        $criteria = ChildEventRatingQuery::create();
        $criteria->add(EventRatingTableMap::COL_EVENTID, $this->eventid);
        $criteria->add(EventRatingTableMap::COL_USERID, $this->userid);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \NorthEastEvents\Models\EventRating (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \NorthEastEvents\Models\EventRating Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(EventRatingTableMap::DEFAULT_STRING_FORMAT);
    }
     ...
     *
     * @return     $this|ChildEventRating The current object (for fluent API support)
     */
