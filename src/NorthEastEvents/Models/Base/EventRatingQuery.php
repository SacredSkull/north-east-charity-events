 ...
 *
 * @method     ChildEventRatingQuery leftJoinEvent($relationAlias = null) Adds a LEFT JOIN clause to the query using the Event relation
 * @method     ChildEventRatingQuery rightJoinEvent($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Event relation
 * @method     ChildEventRatingQuery innerJoinEvent($relationAlias = null) Adds a INNER JOIN clause to the query using the Event relation
 *
 * @method     ChildEventRatingQuery joinWithEvent($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Event relation
 *
 * @method     ChildEventRatingQuery leftJoinWithEvent() Adds a LEFT JOIN clause and with to the query using the Event relation
 * @method     ChildEventRatingQuery rightJoinWithEvent() Adds a RIGHT JOIN clause and with to the query using the Event relation
 * @method     ChildEventRatingQuery innerJoinWithEvent() Adds a INNER JOIN clause and with to the query using the Event relation
 *
 * @method     ChildEventRatingQuery leftJoinUser($relationAlias = null) Adds a LEFT JOIN clause to the query using the User relation
 * @method     ChildEventRatingQuery rightJoinUser($relationAlias = null) Adds a RIGHT JOIN clause to the query using the User relation
 * @method     ChildEventRatingQuery innerJoinUser($relationAlias = null) Adds a INNER JOIN clause to the query using the User relation
 *
 * @method     ChildEventRatingQuery joinWithUser($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the User relation
 *
 * @method     ChildEventRatingQuery leftJoinWithUser() Adds a LEFT JOIN clause and with to the query using the User relation
 * @method     ChildEventRatingQuery rightJoinWithUser() Adds a RIGHT JOIN clause and with to the query using the User relation
 * @method     ChildEventRatingQuery innerJoinWithUser() Adds a INNER JOIN clause and with to the query using the User relation
 *
...
abstract class EventRatingQuery extends ModelCriteria
{
    ...
    public function filterByRating($rating = null, $comparison = null)
    {
        if (is_array($rating)) {
            $useMinMax = false;
            if (isset($rating['min'])) {
                $this->addUsingAlias(EventRatingTableMap::COL_RATING, $rating['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($rating['max'])) {
                $this->addUsingAlias(EventRatingTableMap::COL_RATING, $rating['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildEventRatingQuery The current query, for fluid interface
     */
    public function filterByEvent($event, $comparison = null)
    {
        if ($event instanceof \NorthEastEvents\Models\Event) {
            return $this
                ->addUsingAlias(EventRatingTableMap::COL_EVENTID, $event->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(EventRatingTableMap::COL_EVENTID, $event->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    public function filterByUser($user, $comparison = null)
    {
        if ($user instanceof \NorthEastEvents\Models\User) {
            return $this
                ->addUsingAlias(EventRatingTableMap::COL_USERID, $user->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(EventRatingTableMap::COL_USERID, $user->toKeyValue('Id', 'Id'), $comparison);
        } else {
    ...
    protected function basePreDelete(ConnectionInterface $con)
    {
        ...
        $this->findRelatedEventAverageRatings($con);
    ...
    {
        // aggregate_column_relation_2 behavior
        $this->updateRelatedEventAverageRatings($con);
     ...
     * @param ConnectionInterface $con A connection object
     */
    protected function findRelatedEventAverageRatings($con)
    {
        $criteria = clone $this;
        ...
        $this->eventAverageRatings = \NorthEastEvents\Models\EventQuery::create()
            ->joinEventRating($alias)
            ->mergeWith($criteria)
            ->find($con);
    }

    protected function updateRelatedEventAverageRatings($con)
    {
        foreach ($this->eventAverageRatings as $eventAverageRating) {
            $eventAverageRating->updateAverageRating($con);
        }
        $this->eventAverageRatings = array();
    }
