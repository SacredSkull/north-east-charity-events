...
class ThreadTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'NorthEastEvents.Models.Map.ThreadTableMap';
     ...
     */
    const OM_CLASS = '\\NorthEastEvents\\Models\\Thread';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'NorthEastEvents.Models.Thread';
     ...
     */
    const COL_EVENTID = 'thread.eventID';

    /**
     * the column name for the userID field
     */
    const COL_USERID = 'thread.userID';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'thread.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'thread.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Title', 'EventID', 'UserID', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('id', 'title', 'eventID', 'userID', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(ThreadTableMap::COL_ID, ThreadTableMap::COL_TITLE, ThreadTableMap::COL_EVENTID, ThreadTableMap::COL_USERID, ThreadTableMap::COL_CREATED_AT, ThreadTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id', 'title', 'eventID', 'userID', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Title' => 1, 'EventID' => 2, 'UserID' => 3, 'CreatedAt' => 4, 'UpdatedAt' => 5, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'title' => 1, 'eventID' => 2, 'userID' => 3, 'createdAt' => 4, 'updatedAt' => 5, ),
        self::TYPE_COLNAME       => array(ThreadTableMap::COL_ID => 0, ThreadTableMap::COL_TITLE => 1, ThreadTableMap::COL_EVENTID => 2, ThreadTableMap::COL_USERID => 3, ThreadTableMap::COL_CREATED_AT => 4, ThreadTableMap::COL_UPDATED_AT => 5, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'title' => 1, 'eventID' => 2, 'userID' => 3, 'created_at' => 4, 'updated_at' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\NorthEastEvents\\Models\\Thread');
        $this->setPackage('NorthEastEvents.Models');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('id', 'Id', 'INTEGER', true, null, null);
        $this->addColumn('title', 'Title', 'VARCHAR', true, 50, null);
        $this->addForeignKey('eventID', 'EventID', 'INTEGER', 'event', 'id', true, null, null);
  ...
  array (
    ...
    /**
     * Method to invalidate the instance pool of all tables related to thread     * by a foreign key with ON DELETE CASCADE
     */
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ThreadTableMap::COL_EVENTID);
            $criteria->addSelectColumn(ThreadTableMap::COL_USERID);
            $criteria->addSelectColumn(ThreadTableMap::COL_CREATED_AT);
            $criteria->addSelectColumn(ThreadTableMap::COL_UPDATED_AT);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \NorthEastEvents\Models\Thread) { // it's a model object
